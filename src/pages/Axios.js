    ...
    <div className='axiosComponent'>
      <div className='axiosComponent__details'>
        ...
        <ul>
          ...
          <li>
            Authentication is important for the applications as it provides data and resource protection from unauthorised access to the application
          </li>
          <li>
            GET Method is generally used when we are trying to retreive the data from the server and POST Method is used when we are trying to submit the data to the server
          </li>
          <li>
          ...
          <li>
            Axios is promise-based so we can take advantage of async/await in our code and make it simplier and more readable whereas jQuery is callback-based which can make code more difficult to read and understand
          </li>
          <li>
